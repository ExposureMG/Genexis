...
Settings::Settings(QObject *parent)
    : QObject(parent)
    , m_buildBackend(QStringLiteral("gxbuild3"))
...
void Settings::loadSettings()
{
    ...
    setBuildBackend(ini.value(QStringLiteral("buildBackend"), QStringLiteral("gxbuild3")).toString());
    setFlashBackend(ini.value(QStringLiteral("flashBackend"), QStringLiteral("NandProMax")).toString());
    setTimingFlashBackend(ini.value(QStringLiteral("timingFlashBackend"), QStringLiteral("NandProMax")).toString());
    setWirelessBackend(ini.value(QStringLiteral("wirelessBackend"), QStringLiteral("UpdClient")).toString());
