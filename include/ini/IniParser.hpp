...
struct Entry {
  ...
  uint8_t chain{0};
  std::string comment; // optional comment or comment text
};
...
struct Document {
  ...
  void add_comment(std::string_view section_name, std::string_view comment,
                   char comment_char = ';');
};
...
[[nodiscard]] Entry MakeEntry(std::string_view key, std::string_view value,
                              ...
                              std::string_view comment = "");
[[nodiscard]] Entry MakeComment(std::string_view comment,
                               char comment_char = ';');
