...
class NandBuilderController : public QObject {
    ...
    Q_PROPERTY(QStringList buildVersions READ buildVersions NOTIFY buildVersionsChanged)
    ...
    Q_PROPERTY(QString selectedImageType READ selectedImageType WRITE setSelectedImageType NOTIFY selectedImageTypeChanged)

    Q_PROPERTY(QStringList consoles READ consoles NOTIFY consolesChanged)
    Q_PROPERTY(QString selectedConsole READ selectedConsole WRITE setSelectedConsole NOTIFY selectedConsoleChanged)

    Q_PROPERTY(QStringList xellHacks READ xellHacks NOTIFY xellHacksChanged)
    Q_PROPERTY(QString selectedXellHack READ selectedXellHack WRITE setSelectedXellHack NOTIFY selectedXellHackChanged)

    Q_PROPERTY(QStringList xellImages READ xellImages NOTIFY xellImagesChanged)
    Q_PROPERTY(QString selectedXellImage READ selectedXellImage WRITE setSelectedXellImage NOTIFY selectedXellImageChanged)

    Q_PROPERTY(QStringList simpleVersions READ simpleVersions NOTIFY simpleVersionsChanged)
    Q_PROPERTY(QString selectedSimpleVersion READ selectedSimpleVersion WRITE setSelectedSimpleVersion NOTIFY selectedSimpleVersionChanged)

    Q_PROPERTY(QStringList simpleImageTypes READ simpleImageTypes NOTIFY simpleImageTypesChanged)
    Q_PROPERTY(QString selectedSimpleImageType READ selectedSimpleImageType WRITE setSelectedSimpleImageType NOTIFY selectedSimpleImageTypeChanged)
...
private:
    ...
    QString getXellDataPath() const;
    QString findRgBuildVersionFolder(const QString &version) const;
