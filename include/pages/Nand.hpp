...
class Nand : public QObject
{
    ...
    Q_PROPERTY(QString loadedFilePath READ loadedFilePath NOTIFY loadedFilePathChanged)
    ...
    Q_PROPERTY(QString payloadIndicator READ payloadIndicator NOTIFY metadataChanged)
    ...
    Q_PROPERTY(QString smcConfigOffset READ smcConfigOffset NOTIFY metadataChanged)
...
public:
    ...
    QString payloadIndicator() const { return m_payloadIndicator; }
    ...
    Q_INVOKABLE void openFile(const QString &filePath, const QString &cpuKey = QString());
...
private:
    ...
    void parseKeyvault(const std::vector<uint8_t> &cpuKeyBytes, const std::vector<uint8_t> &rawKv);
